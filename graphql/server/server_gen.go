...
type FileResolver interface {
	Tags(ctx context.Context, obj *model.File, after *string, before *string, first *int, last *int, filter *model.TagFilter, sort *model.TagSort, order *model.Order) (*model.Connection[model.Tag], error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "File.tags":
		...
		return e.complexity.File.Tags(childComplexity, args["after"].(*string), args["before"].(*string), args["first"].(*int), args["last"].(*int), args["filter"].(*model.TagFilter), args["sort"].(*model.TagSort), args["order"].(*model.Order)), true
...
func (ec *executionContext) _File_tags(ctx context.Context, field graphql.CollectedField, obj *model.File) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.File().Tags(rctx, obj, fc.Args["after"].(*string), fc.Args["before"].(*string), fc.Args["first"].(*int), fc.Args["last"].(*int), fc.Args["filter"].(*model.TagFilter), fc.Args["sort"].(*model.TagSort), fc.Args["order"].(*model.Order))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_File_tags(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_File_tags_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return
	}
	return fc, nil
